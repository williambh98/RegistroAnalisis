...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">Consulta de Tipo Analisis</div>
                ...
                <div class="modal-dialog" style="max-width: 600px!important; min-width: 300px!important">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">REPORTE TIPO ANALISIS</h5>
                        ...
                        <div class="modal-body">
                            <%--Viewer--%>
                            <rsweb:ReportViewer ID="MyTipoAnalisisReportViewer" runat="server" ProcessingMode="Remote" Height="500px" Width="500px">
